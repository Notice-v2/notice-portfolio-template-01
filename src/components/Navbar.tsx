...
export const Navbar = ({ meta, color }: Props) => {
	...
	return (
		<nav className="fixed top-0 z-50 flex items-center justify-between py-2 px-4 md:px-10 lg:px-14 w-full">
			<div className="flex items-center justify-between gap-4 w-full h-20 md:h-28">
